        ...
        <nav className="bg-electric-800 border-b border-electric-600">
          <div className="container mx-auto px-4 py-3 flex items-center justify-between">
            <Link href="/" className="flex items-center gap-3 hover:opacity-90 transition-opacity">
              ...
              />
              <span className="hidden text-white font-bold text-xl sm:block">LEO Badminton Club</span>
            </Link>
            <div className="flex gap-1 items-center sm:gap-4">
              <Link 
                href="/" 
                className="text-white hover:text-coral-400 transition-colors px-2 py-2 text-sm sm:px-3 sm:text-base"
              >
                Weekly
              </Link>
              <Link 
